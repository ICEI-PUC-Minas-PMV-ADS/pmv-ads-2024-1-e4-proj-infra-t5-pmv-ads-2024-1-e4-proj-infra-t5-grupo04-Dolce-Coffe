...
|Fernanda Mendes     | Deseja uma plataforma onde consiga finalizar a compra de maneira rápida | Para facilitar a experiência de compra e economizar tempo |
...
|Raquel Silva        | Deseja uma plataforma onde consiga excluir produtos do carrinho | Para caso mude de ideia |
...
|ID     | Descrição do Requisito  |Prioridade |
|-------|-------------------------|----|
|RNF-001| A aplicação deve ter bom nível de contraste entre os elementos da tela e um design simples, Web  Mobile. | Alta| 
...
|RNF-004| O sistema front-end Web deve ser desenvolvido na linguagem JavaScript com utilização do framework React.js | Alta|
|RNF-005| O sistema front-end Mobile deve ser desenvolvido na linguagem React Native| Alta |
|RNF-006| O sistema front-end Mobile deve ser compatível com sistema operacional Android  | Baixa|
|RNF-007| O site deve ser publicado em um ambiente acessível publicamente na Internet (GitHub) .| Média |
|RNF-008| Os sitemas devem ser compatíveis com a LGPD, Lei Geral de Proteção de Dados | Baixa|
|RNF-010| O código da API deve ser testado de forma abrangente e seguir as melhores práticas de codificação para garantir robustez e confiabilidade| |
|RNF-011| A API deve oferecer controle de versão para que as alterações futuras não quebrem a compatibilidade com os clientes existentes | Média |
|RNF-012| Deve ser implementado um sistema de cache para reduzir a carga do servidor e melhorar o desempenho da API. | Alta |
|RNF-013| A API deve ser capaz de suportar diferentes protocolos de comunicação, como HTTP e HTTPS, para atender às diversas necessidades dos clientes. | Alta |
|RNF-014| O sistema back-end API deve ser desenvolvida na linguagem node.js| Alta |
...
(![casodeuso (1)](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e4-proj-infra-t5-pmv-ads-2024-1-e4-proj-infra-t5-grupo04-Dolce-Coffe/assets/89558202/febe43e5-1f55-454f-a591-2c06521c679a)
